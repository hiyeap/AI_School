{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "# 같은 타입만 배열에 들어갈 수 있으므로 숫자형도 문자열로 바뀐다\n",
    "arr = np.array([1,2,3,'ㅁ'])\n",
    "arr"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    ...
    "# int8 => 1비트당 2개의 숫자를 표현할 수 있음 2^8 = 256개 표현 가능\n",
    "           # (-128 ~ 127)\n",
  ...
  },
  {
   ...
   "source": [
    "# 반복문을 활용하여 1부터 50까지 1씩 증가하는 값들로 리스트 만들기!\n",
    "num_list2 = []\n",
    "for i in range(1, 51):\n",
    "    num_list2.append(i)\n",
    "print(num_list2)"
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "array([[0.16389807, 0.95820186, 0.6450688 ],\n",
       "       [0.23596194, 0.53993429, 0.21563638]])"
      ]
     },
     "execution_count": 27,
     "metadata": {},
  ...
  },
  {
   ...
   "source": [
    "# arr에서 값이 홀수이면 0으로 변경하는 코드를 작성해보세요!\n",
    "arr[arr % 2==1] = 0\n",
    "arr"
   ]
  },
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "- 1번 사용자는 전체 영화의 평점 평균보다 후하게 평점을 줬다."
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    "user_mean_list = []\n",
    "\n",
    "for i in user_id: #range(1, 6041, 1)\n",
    "    # 1번~6040번 사용자가 매긴 평점들의 평균을 각각 구해주는 코드\n",
  ...
  },
  {
   ...
   "source": [
    "movie_list = []\n",
    "for i in movie_id:\n",
    "    movie_list.append([i, movie[movie[:,1]==i][:, 2].mean()])\n",
    "movie_list"
   ]
  },
  {
